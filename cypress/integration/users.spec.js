...
describe("Users Page", () => {
    ...
    it("users page => add new user", () => {
        ...
        cy.url().should("be.equal", "http://localhost:3000/" + URLS.DASHBOARD.LIST.NEW_USER);
    ...
    it("users page => update user", () => {
        cy.get('[data-testid="common-button"]').should('have.length', 14).eq(1).click()
        ...
        cy.get('[data-testid="common-text-field"]')
            ...
            .focus()
            .type("test")
        cy.get('[data-testid="common-button"]').should('have.length.at.least', 1).last().click()
    });
})
